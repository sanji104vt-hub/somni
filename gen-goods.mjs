...
@media(max-width:680px){.nav-links a:not(:first-child){display:none}.grid{grid-template-columns:1fr;gap:12px}.item{padding:12px}.item h3{font-size:.9rem}.wrap{padding:0 14px}}
</style>
</head>
<body>
